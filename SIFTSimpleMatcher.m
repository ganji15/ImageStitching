...
%                                                                              %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    num_descriptor1 = size(descriptor1, 1);
    num_descriptor2 = size(descriptor2, 1);
    for i = 1 : num_descriptor1
       dists = sqrt(sum((descriptor2 - repmat(descriptor1(i, :), num_descriptor2, 1)).^2, 2));
       [sorted_dists, idxs]= sortrows(dists);
       if sorted_dists(1) < sorted_dists(2) * thresh
            match = [match; i, idxs(1)];
       end
    end
